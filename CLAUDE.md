...
| File | Lines | Role |
|---|---|---|
| `index.html` | ~70 | Static shell — empty containers that JS fills |
| `css/styles.css` | ~520 | All styling, tokens, animations, responsive rules |
| `js/script.js` | ~1330 | Bootstrap, data loading, vendor switching, shared listeners |
| `js/intel-v2.js` | ~780 | Intel — generation-first renderer |
| `js/amd-v2.js` | ~815 | AMD — product-first renderer. **GENERATED**, see below |
